...
- Bug：用 [Bug report](https://github.com/singer0503/mini-game/issues/new?template=bug_report.yml) template
- Feature：用 [Feature request](https://github.com/singer0503/mini-game/issues/new?template=feature_request.yml) template
